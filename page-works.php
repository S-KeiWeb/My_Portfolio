<?php get_header(); ?>  
  ...
  <main class="page-wrap">
    ...
    <section class="works-content-wrap">
      ...
      <a class="main-button" href="https://coconala.com/users/2346005" target="_blank">Go To coconala <br class="no-br">(External Sites)</a>
    </section>
    <section class="works-content-wrap">
      <h2 class="main-section-content-title">
      ...
      <a class="main-button" href="<?php echo esc_url( home_url( '/' ) ); ?>contact">Please Message</a>
    </section>
  </main>
<?php endif; ?>
