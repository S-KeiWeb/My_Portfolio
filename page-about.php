					...
					<div class="skill-content-wrap">
						...
						<section>
							...
							<div class="message-image-wrap">
								<img class="message-image" src="<?php echo get_template_directory_uri(); ?>/img/message-img.jpg"
									alt="出身県の風景">
								<p class="message-image-text">故郷岩手県の風景</p>
							</div>
							<p class="message-main-text">
								最後までご覧いただきありがとうございました。<br>日々楽しく、やりたいことをできるようにする<br>36歳の節目にして初めて人生の目的を見つけました。<br>そのために必要なスキルや知識を獲得するため努力し、日々ITリテラシーの向上に取り組んでいます。<br>私の目標は、自身の技術や知識を活かし、多くの人々がITに親しみを持てるようサポートすることです。<br>私は年齢に負けずに情熱を持ち、会社に求められるだけの価値を提供できると確信しており、ぜひ貴社でのチャンスを頂戴したいと考えています。どうぞよろしくお願いいたします。
							</p>
						</section>
					</div>
				</div>
